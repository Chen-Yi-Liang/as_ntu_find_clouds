...
extern double get_x(image_data * data, double e_angle, double azimuth, double r_scale);

extern double get_y(image_data * data, double e_angle, double azimuth, double r_scale);
